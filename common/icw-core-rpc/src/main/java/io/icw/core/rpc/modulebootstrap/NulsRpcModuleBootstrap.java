...
public class NulsRpcModuleBootstrap {
    ...
    private static final String DEFAULT_SCAN_PACKAGE = "io.icw";
    ...
    public static void run(String scanPackage, String[] args) {
        ...
        SpringLiteContext.init(scanPackage, "io.icw.core.rpc.modulebootstrap", "io.icw.core.rpc.cmd", "io.icw.base.protocol");
        RpcModule module;
        try {
