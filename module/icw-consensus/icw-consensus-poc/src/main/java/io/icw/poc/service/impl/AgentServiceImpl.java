...
import io.icw.poc.model.dto.input.SearchAgentDTO;
import io.icw.poc.model.dto.input.SearchAllAgentDTO;
import io.icw.poc.model.dto.input.StopAgentDTO;
import io.icw.poc.model.dto.output.AgentDTO;
...
import io.icw.poc.service.AgentService;
...
public class AgentServiceImpl implements AgentService {
    ...
    public Result getPackerInfo(Map<String, Object> params) {
        ...
        try {
//            MeetingRound round = roundManager.getCurrentRound(chain);
        	MeetingRound round = roundManager.getRound(chain);
