...
//    }
    ...
    public static String tokenName(int chainid, Object contractAddress) {
        try {
            ...
            Map map = result.getData();
            if (map == null) {
                return ApiConstant.EMPTY_STRING;
            }
            ...
            for (Map<String, Object> resultMap : resultList) {
                ...
                if (assetList != null) {
                    for (Map<String, Object> assetMap : assetList) {
                        ...
                        if (usable) {
                            assetInfo.setStatus(ApiConstant.ENABLE);
                        } else {
                            assetInfo.setStatus(ApiConstant.DISABLE);
                        }
