...
import io.icw.block.manager.ChainManager;
import io.icw.block.manager.ContextManager;
import io.icw.block.model.BlockConfig;
import io.icw.block.thread.BlockSynchronizer;
import io.icw.block.thread.monitor.*;
...
public class BlockBootstrap extends RpcModule {
    ...
    private void initDb() throws Exception {
        ...
        RocksDBService.createTable(Constant.CHAIN_LATEST_HEIGHT);
        RocksDBService.createTable(Constant.CHAIN_PARAMETERS);
        RocksDBService.createTable(Constant.PROTOCOL_CONFIG);
        RocksDBService.createTable(Constant.ROLLBACK_HEIGHT);
    }
